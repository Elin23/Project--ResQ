...
export class InMemoryRescueRepository implements RescueRepository {
  ...
  async createFromReport(reportId: string, organizationId: string) {
    ...
    const task: RescueTask = {
      ...
      imageUri: "https://images.unsplash.com/photo-1543466835-00a7907e9de1?auto=format&fit=crop&w=1000&q=82",
      mapImageUri: "https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=1200&q=82",
      progress: 15,
      stage: "accepted",
