...
const styles = StyleSheet.create({
  ...
  primaryBadge: { position: "absolute", top: SPACING.sm, right: SPACING.sm, backgroundColor: COLORS.primaryStrongFill, borderRadius: RADIUS.full, paddingHorizontal: SPACING.sm, paddingVertical: 3 },
  imageActions: { position: "absolute", bottom: SPACING.sm, left: SPACING.sm, flexDirection: "row", direction: "rtl", gap: SPACING.xs },
  imageAction: { width: 44, height: 44, borderRadius: RADIUS.full, backgroundColor: COLORS.surface, alignItems: "center", justifyContent: "center" },
