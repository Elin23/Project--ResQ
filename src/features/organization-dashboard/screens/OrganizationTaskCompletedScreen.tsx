...
const styles = StyleSheet.create({
  ...
  summaryHeader: { flexDirection: "row", direction: "rtl", alignItems: "center", justifyContent: "space-between" }, donePill: { backgroundColor: COLORS.successFill, borderRadius: RADIUS.full, paddingHorizontal: SPACING.md, paddingVertical: SPACING.xs }, summaryText: { alignItems: "stretch" }, summaryRow: { flexDirection: "row", direction: "rtl", alignItems: "center", justifyContent: "space-between", marginTop: SPACING.md }, animal: { flexDirection: "row", direction: "rtl", alignItems: "center", gap: SPACING.xs },
  grid: { flexDirection: "row", direction: "rtl", flexWrap: "wrap", gap: SPACING.sm, marginBottom: SPACING.md }, stat: { width: "48.5%", minHeight: 112, borderRadius: RADIUS.md, backgroundColor: COLORS.rescueInput, alignItems: "center", justifyContent: "center", gap: SPACING.xs }, rtl: { textAlign: "auto", writingDirection: "rtl" }, impact: { flexDirection: "row", direction: "rtl", alignItems: "center", justifyContent: "flex-end", gap: SPACING.sm, marginTop: SPACING.sm }, impactIcon: { width: 34, height: 34, borderRadius: RADIUS.full, backgroundColor: COLORS.surface, alignItems: "center", justifyContent: "center" },
  sectionTitle: { textAlign: "auto", marginTop: SPACING.lg, marginBottom: SPACING.md }, completedTimeline: { marginBottom: SPACING.lg }, completedRow: { minHeight: 62, flexDirection: "row", direction: "rtl", justifyContent: "flex-end" }, completedText: { flex: 1, alignItems: "stretch", paddingStart: SPACING.md }, completedRail: { width: 24, alignItems: "center" }, completedDot: { width: 16, height: 16, borderRadius: RADIUS.full, backgroundColor: COLORS.rescueSuccess }, completedLine: { width: 2, minHeight: 46, flex: 1, backgroundColor: COLORS.orgStatGreenBorder },
