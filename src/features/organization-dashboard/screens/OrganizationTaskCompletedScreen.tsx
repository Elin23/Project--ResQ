...
const styles = StyleSheet.create({
  ...
  grid: { flexDirection: "row", direction: "rtl", flexWrap: "wrap", gap: SPACING.sm, marginBottom: SPACING.md }, stat: { width: "48.5%", minHeight: 112, borderRadius: RADIUS.md, backgroundColor: COLORS.rescueInput, alignItems: "center", justifyContent: "center", gap: SPACING.xs }, rtl: { textAlign: "auto", writingDirection: "rtl" }, impact: { flexDirection: "row", direction: "rtl", alignItems: "center", justifyContent: "flex-end", gap: SPACING.sm, marginTop: SPACING.sm }, impactIcon: { width: 34, height: 34, borderRadius: RADIUS.full, backgroundColor: COLORS.white, alignItems: "center", justifyContent: "center" },
