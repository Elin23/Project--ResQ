...
const styles = StyleSheet.create({
  ...
  statusRow: { flexDirection: "row", direction: "rtl", alignItems: "center", justifyContent: "space-between", gap: SPACING.sm, marginBottom: SPACING.lg }, urgentPill: { backgroundColor: COLORS.dangerFill, borderRadius: RADIUS.full, paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs }, codeWrap: { flex: 1, alignItems: "stretch", gap: SPACING.xxs },
