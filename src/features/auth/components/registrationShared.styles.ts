...
export const styles = StyleSheet.create({
  ...
  sectionMarker: { width: 4, height: 24, borderRadius: RADIUS.xs, backgroundColor: COLORS.primaryFill },
  ...
  progressFill: { height: "100%", borderRadius: RADIUS.xs, backgroundColor: COLORS.primaryFill },
