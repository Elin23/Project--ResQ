...
import { initialAccountStatus } from "@/src/types/accounts";

const CODE_LENGTH = 6;
const RESEND_SECONDS = 45;
const TEST_CODE = "123456";

type AccountType = "user" | "entity";
...
export default function VerifyRegistrationPhoneScreen() {
  ...
  const accountType: AccountType =
    params.accountType === "entity" ? "entity" : "user";

  const entityType: EntityType | undefined =
    params.entityType === "organization" ? "organization" : undefined;
  ...
  const navigateAfterSuccess = async () => {
    await startAuthenticatedSession({
      kind: accountType === "entity" ? "organization" : "user",
      status: initialAccountStatus(accountType === "entity" ? "organization" : "user"),
      displayName: typeof params.name === "string" ? params.name : undefined,
            ...
            <View style={[styles.content, { width: contentWidth }]}>
              ...
              <View style={styles.form}>
                ...
                <View style={styles.testCodeCard}>
                  <Ionicons name="flask-outline" size={19} color={PALETTE.green700} />
                ...
                <Button
                  ...
                  fullWidth
                  backgroundColor={
                    code.length === CODE_LENGTH ? PALETTE.orange500 : COLORS.borderStrong
                  }
                  borderColor={
                    code.length === CODE_LENGTH ? PALETTE.orange500 : COLORS.borderStrong
                  }
                  borderWidth={0}
                  textColor={
                    code.length === CODE_LENGTH ? COLORS.icon : PALETTE.neutral0
                  }
                  radius={16}
                  style={[
                    styles.verifyButton,
