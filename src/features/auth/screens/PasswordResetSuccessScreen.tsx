    ...
    <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
      ...
      >
        ...
        <ScreenHeader
          ...
          onBack={handleBack}
          backAccessibilityLabel="العودة إلى تسجيل الدخول"
        ...
        >
          ...
          >
            ...
            >
              <View style={styles.statusRow}>
                <View style={styles.statusIcon}>
                  <Ionicons name="checkmark" size={17} color={PALETTE.neutral0} />
                </View>
            ...
            >
              ...
              >
                <Ionicons name="home-outline" size={18} color={COLORS.primaryStrong} />
