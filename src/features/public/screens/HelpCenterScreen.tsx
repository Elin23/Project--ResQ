        ...
        >
          <View style={[styles.content, { width: contentWidth }]}>
            ...
            <View style={styles.searchContainer}>
              <Ionicons name="search-outline" size={22} color={COLORS.iconMuted} />
                  ...
                  <View style={styles.categoriesGrid}>
                    {filteredCategories.map((item) => (
                      <Pressable
                        ...
                        onPress={() => focusCategory(item.title)}
                        style={({ pressed }) => [
                          styles.categoryCard,
            ...
            <View style={styles.supportCard}>
              ...
              >
                <Ionicons name="chatbox-outline" size={20} color={PALETTE.neutral0} />
            ...
            <View style={styles.linksCard}>
              <Pressable
                onPress={() => openPublicRoute("/privacy-policy")}
                style={({ pressed }) => [
                  styles.linkRow,
              ...
              <Pressable
                onPress={() => openPublicRoute("/terms-and-conditions")}
                style={({ pressed }) => [
                  styles.linkRow,
                  pressed && styles.linkPressed,
                ]}
            ...
            <View style={styles.footer}>
              ...
              <View style={styles.footerLinks}>
                <Pressable onPress={() => openPublicRoute("/privacy-policy")}>
                  <AppText style={styles.footerLink}>سياسة الخصوصية</AppText>
                </Pressable>

                <Pressable onPress={() => openPublicRoute("/terms-and-conditions")}>
