            ...
            <View style={styles.contactInfoCard}>
              ...
              >
                <View style={styles.contactIconOrange}>
                  <Ionicons name="mail-outline" size={21} color={COLORS.primaryStrong} />
                </View>
                ...
                {SOCIAL_ITEMS.map((item) => (
                  ...
                  >
                    <View style={styles.socialIcon}>
                      <Ionicons name={item.icon} size={21} color={COLORS.textSecondary} />
                    </View>
          ...
          >
            ...
            >
              <View style={styles.modalHeader}>
                ...
                >
                  <Ionicons name="close" size={21} color={COLORS.icon} />
                </Pressable>
              </View>
                ...
                return (
                  ...
                  >
                    <Ionicons
                      ...
                      size={21}
                      color={isSelected ? COLORS.primaryStrong : COLORS.iconMuted}
                    />
