...
/**
 * TODO: استبدل الجوّا بـ react-native-maps لما يجهز الـ dev build.
 * البروبس نهائية — الشاشة ما لازم تتغير.
 */
  ...
  return (
    <View style={[styles.container, { height }]}>
      ...
      <View style={styles.badge}>
        ...
        <AppText size={10} color={COLORS.textSecondary}>
          الخريطة قيد الإنشاء
        </AppText>
      </View>

      <Pressable style={styles.locateButton} hitSlop={8}>
