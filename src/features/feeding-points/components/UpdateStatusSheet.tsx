...
export default function UpdateStatusSheet({
  ...
  const pickPhoto = async () => {
    ...
    if (!handlePermission(permission, { title: "صلاحية الصور مطلوبة", message: "اسمح بالوصول إلى الصور لإرفاق صورة حديثة لنقطة الإطعام." })) return;
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={handleClose}>
      <Pressable accessible={false} style={styles.backdrop} onPress={handleClose}>
        <Pressable accessible={false} accessibilityViewIsModal style={styles.sheet} onPress={(event) => event.stopPropagation()}>
          <AppText accessibilityRole="header" weight="bold" size={FONT_SIZES.title}>
            تسجيل تغذية
          </AppText>
          ...
          <Pressable
            ...
            accessibilityLabel={photoUri ? "تغيير صورة إثبات حالة نقطة الإطعام" : "إضافة صورة إثبات حالة نقطة الإطعام"}
            onPress={pickPhoto}
