...
const styles = StyleSheet.create({
  ...
  urgentPill: { position: "absolute", top: SPACING.md, right: SPACING.md, flexDirection: "row", direction: "rtl", alignItems: "center", gap: SPACING.xxs, paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs, backgroundColor: COLORS.dangerFill, borderRadius: RADIUS.full },
