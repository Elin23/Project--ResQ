...
const styles = StyleSheet.create({
  ...
  heroButton: { marginTop: SPACING.sm, alignSelf: "flex-start", minHeight: 42, paddingHorizontal: SPACING.xl, borderRadius: RADIUS.full, backgroundColor: COLORS.primaryFill, alignItems: "center", justifyContent: "center" },
  ...
  urgentBadge: { position: "absolute", top: SPACING.md, right: SPACING.md, backgroundColor: COLORS.dangerFill, borderRadius: RADIUS.full, paddingHorizontal: SPACING.sm, paddingVertical: SPACING.xs },
  ...
  progressFill: { height: "100%", backgroundColor: COLORS.successFill, borderRadius: RADIUS.full },
